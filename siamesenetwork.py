...
class SiameseNetworkDataset(Dataset):
    ...
    def __getitem__(self,index):
        ...
        return img0/255., img1/255. , torch.from_numpy(np.array([int(img1_tuple[1]!=img0_tuple[1])],dtype=np.float32))
...
class TripletDataset(Dataset):
    ...
    def __getitem__(self,index):
        ...
        img0 = Image.open(anchor[0])
        img1 = Image.open(positive[0])
        img2 = Image.open(negative[0])
        img0 = img0.convert("L")
        img1 = img1.convert("L")
        img2 = img2.convert("L")
